...
public class CompanyRestController {
    ...
    public ResponseEntity<Company> createWithLocation(@RequestBody String companyJson) {
        if (new Validation().validate(companyJson, COMPANY_SCHEMA)) {
            Company company = mapCompany(companyJson);
    ...
    private Company mapCompany(String json) {
